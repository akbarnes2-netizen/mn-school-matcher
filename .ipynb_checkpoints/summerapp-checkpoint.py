...
def results():
    if request.method == 'GET':
        # Minimal placeholder so Frozen-Flask can create results.html
...
def total():
    if request.method == 'GET':
        # Minimal placeholder so Frozen-Flask can create total.html
        return render_template('total.html', table="")
